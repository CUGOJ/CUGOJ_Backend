...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20221111155138_v3-initial')
BEGIN
    ALTER TABLE [UserOrganizationLinks] DROP CONSTRAINT [PK_UserOrganizationLinks];
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20221111155138_v3-initial')
BEGIN
    EXEC sp_rename N'[UserOrganizationLinks]', N'user_organization_link';
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20221111155138_v3-initial')
BEGIN
    EXEC sp_rename N'[user_organization_link].[IX_UserOrganizationLinks_user_id]', N'IX_user_organization_link_user_id', N'INDEX';
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20221111155138_v3-initial')
BEGIN
    EXEC sp_rename N'[user_organization_link].[IX_UserOrganizationLinks_organization_id_role]', N'IX_user_organization_link_organization_id_role', N'INDEX';
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20221111155138_v3-initial')
BEGIN
    ALTER TABLE [user_organization_link] ADD CONSTRAINT [PK_user_organization_link] PRIMARY KEY ([id]);
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20221111155138_v3-initial', N'6.0.10');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20221111170700_v4-initial')
BEGIN
    EXEC sp_rename N'[organization].[Role]', N'role', N'COLUMN';
END;
GO
...
BEGIN
    ...
    SET @defaultSchema = SCHEMA_NAME();
    DECLARE @description AS sql_variant;
    SET @description = N'父组织中的身份';
    EXEC sp_addextendedproperty 'MS_Description', @description, 'SCHEMA', @defaultSchema, 'TABLE', N'organization', 'COLUMN', N'role';
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20221111170700_v4-initial')
BEGIN
    ALTER TABLE [organization] ADD [organization_type] int NOT NULL DEFAULT 0;
    DECLARE @defaultSchema AS sysname;
    SET @defaultSchema = SCHEMA_NAME();
    DECLARE @description AS sql_variant;
    SET @description = N'组织类型';
    EXEC sp_addextendedproperty 'MS_Description', @description, 'SCHEMA', @defaultSchema, 'TABLE', N'organization', 'COLUMN', N'organization_type';
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20221111170700_v4-initial')
BEGIN
    ALTER TABLE [organization] ADD [signature] nvarchar(max) NULL;
    DECLARE @defaultSchema AS sysname;
    SET @defaultSchema = SCHEMA_NAME();
    DECLARE @description AS sql_variant;
    SET @description = N'个性签名';
    EXEC sp_addextendedproperty 'MS_Description', @description, 'SCHEMA', @defaultSchema, 'TABLE', N'organization', 'COLUMN', N'signature';
END;
GO
...
BEGIN
    CREATE TABLE [authorize] (
        ...
        CONSTRAINT [PK_authorize] PRIMARY KEY ([id])
    );
    DECLARE @defaultSchema AS sysname;
    SET @defaultSchema = SCHEMA_NAME();
    DECLARE @description AS sql_variant;
    SET @description = N'Id';
    EXEC sp_addextendedproperty 'MS_Description', @description, 'SCHEMA', @defaultSchema, 'TABLE', N'authorize', 'COLUMN', N'id';
    SET @description = N'被授权对象种类';
    EXEC sp_addextendedproperty 'MS_Description', @description, 'SCHEMA', @defaultSchema, 'TABLE', N'authorize', 'COLUMN', N'grantee_type';
    SET @description = N'被授权对象Id';
    EXEC sp_addextendedproperty 'MS_Description', @description, 'SCHEMA', @defaultSchema, 'TABLE', N'authorize', 'COLUMN', N'grantee_id';
    SET @description = N'被授权对象的';
    EXEC sp_addextendedproperty 'MS_Description', @description, 'SCHEMA', @defaultSchema, 'TABLE', N'authorize', 'COLUMN', N'role';
    SET @description = N'资源类型';
    EXEC sp_addextendedproperty 'MS_Description', @description, 'SCHEMA', @defaultSchema, 'TABLE', N'authorize', 'COLUMN', N'resource_type';
    SET @description = N'资源Id';
    EXEC sp_addextendedproperty 'MS_Description', @description, 'SCHEMA', @defaultSchema, 'TABLE', N'authorize', 'COLUMN', N'resource_id';
    SET @description = N'授权的权限集合,按位表示';
    EXEC sp_addextendedproperty 'MS_Description', @description, 'SCHEMA', @defaultSchema, 'TABLE', N'authorize', 'COLUMN', N'action';
    SET @description = N'创建时间';
    EXEC sp_addextendedproperty 'MS_Description', @description, 'SCHEMA', @defaultSchema, 'TABLE', N'authorize', 'COLUMN', N'create_time';
    SET @description = N'最后更新时间';
    EXEC sp_addextendedproperty 'MS_Description', @description, 'SCHEMA', @defaultSchema, 'TABLE', N'authorize', 'COLUMN', N'update_time';
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20221111170700_v4-initial')
BEGIN
    CREATE INDEX [IX_authorize_grantee_id_resource_id] ON [authorize] ([grantee_id], [resource_id]);
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20221111170700_v4-initial', N'6.0.10');
END;
GO
